...
const AddObservationScreen = ({ navigation, route }) => {
  ...
  const observationDate = retroactiveDate
  ...
  const requestPermissions = async () => {
    try {
      ...
      if (cam.status !== "granted" || media.status !== "granted") {
        Alert.alert(
          "Behörigheter krävs",
          "Vi behöver tillgång till kamera och galleri",
        );
        return false;
      }
      return true;
  ...
  const handleSave = async () => {
    ...
    const observation = {
      ...
      tags: allTags,
      category,
      subcategory: ["Djur", "Växt", "Insekt", "Svamp"].includes(category)
        ? subcategory
        : "",
      season,
      ...
      <ScrollView style={styles.container}>
        {retroactiveDate && (
          <View style={styles.dateBadge}>
            ...
            {dayNumber && (
              <Text style={styles.dateBadgeDay}>Dag {dayNumber} av 365</Text>
            )}
          </View>
        )}
          ...
          <View style={styles.seasonContainer}>
            {["Vår", "Sommar", "Höst", "Vinter"].map((s) => (
              ...
              >
                ...
                <Text
                  style={[
                    styles.seasonButtonLabel,
                    season === s && styles.seasonButtonLabelActive,
                  ]}
                >
                  {s}
                </Text>
                ...
                {[
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      subcategory === key && styles.subcategoryButtonActive,
                    ]}
                    onPress={() =>
                      setSubcategory(subcategory === key ? "" : key)
                    }
                  >
                    ...
                    <Text
                      style={[
                        ...
                        subcategory === key && styles.subcategoryLabelActive,
                      ]}
                    >
                      {key}
                    </Text>
...
const styles = StyleSheet.create({
  ...
  savedButtonSecondary: {
    ...
    alignItems: "center",
    borderWidth: 2,
    borderColor: BeeColors.honey,
  },
  savedButtonSecondaryText: {
    color: BeeColors.honey,
    fontSize: 18,
    fontWeight: "bold",
  },
  ...
  input: {
    borderWidth: 2,
    borderColor: BeeColors.honeyLight,
    borderRadius: 10,
    padding: 12,
    fontSize: 16,
    marginBottom: 20,
  ...
  categoryButtonActive: {
    backgroundColor: BeeColors.honeyDark,
    borderColor: BeeColors.honeyDark,
  },
